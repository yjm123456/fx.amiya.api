...
{
    public class UeOrderNewAppointSiteRequest : JdRequestBase<UeOrderNewAppointSiteResponse>
    {
                                                                                                                                              public  		string
              county
 {get; set;}
 ...
 {get; set;}
            ...
            {
                get{return "jingdong.ue.order.new.appointSite";}
            }
            protected override void PrepareParam(IDictionary<String, Object> parameters)
            {
                                                                                                        ...
                                                                                                        parameters.Add("siteAcceptDate", this.            siteAcceptDate
);
                                                                            }
    }
}
