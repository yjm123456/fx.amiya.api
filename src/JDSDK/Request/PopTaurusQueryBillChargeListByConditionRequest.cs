...
{
    public class PopTaurusQueryBillChargeListByConditionRequest : JdRequestBase<PopTaurusQueryBillChargeListByConditionResponse>
    {
 ...
 {get; set;}
            ...
            {
                get{return "jingdong.pop.taurus.queryBillChargeListByCondition";}
            }
