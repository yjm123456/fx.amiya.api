...
{
    public class AscAuditHomepickRequest : JdRequestBase<AscAuditHomepickResponse>
    {
                                                                                                                                                                                                                                                 public  		string
              buId
 {get; set;}
 ...
 {get; set;}
            ...
            {
                get{return "jingdong.asc.audit.homepick";}
            }
            protected override void PrepareParam(IDictionary<String, Object> parameters)
            {
                                                                                                        ...
                                                                                                        parameters.Add("pickupStandard", this.            pickupStandard
);
