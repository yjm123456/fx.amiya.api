...
{
    public class UeOrderNewAppointEngineerRequest : JdRequestBase<UeOrderNewAppointEngineerResponse>
    {
                                                                                                                                              public  		string
              county
 {get; set;}
 ...
 {get; set;}
            ...
            {
                get{return "jingdong.ue.order.new.appointEngineer";}
            }
            protected override void PrepareParam(IDictionary<String, Object> parameters)
            {
                                                                                                        ...
                                                                                                        parameters.Add("engAcceptDate", this.            engAcceptDate
);
                                                                            }
    }
}
