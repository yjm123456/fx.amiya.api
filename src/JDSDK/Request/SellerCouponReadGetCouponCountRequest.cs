...
{
    public class SellerCouponReadGetCouponCountRequest : JdRequestBase<SellerCouponReadGetCouponCountResponse>
    {
                                                                                                                                                                                                                public  		string
              ip
 {get; set;}
 ...
 {get; set;}
            ...
            {
                get{return "jingdong.seller.coupon.read.getCouponCount";}
            }
