...
{
    public class AscProcessOffLineChangeCancelRequest : JdRequestBase<AscProcessOffLineChangeCancelResponse>
    {
                                                                                                                                                                                                                                                 public  		string
              buId
 {get; set;}
 ...
 {get; set;}
            ...
            {
                get{return "jingdong.asc.process.offLineChange.cancel";}
            }
