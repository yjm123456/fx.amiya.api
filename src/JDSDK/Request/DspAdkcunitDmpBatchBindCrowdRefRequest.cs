...
{
    public class DspAdkcunitDmpBatchBindCrowdRefRequest : JdRequestBase<DspAdkcunitDmpBatchBindCrowdRefResponse>
    {
 ...
 {get; set;}
  ...
  adGroupPrice {get; set; }
            ...
            {
                get{return "jingdong.dsp.adkcunit.dmp.batchBindCrowdRef";}
            }
