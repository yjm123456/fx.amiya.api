...
{
    public class SellerPromotionV2UnitBeanrequiredCreateRequest : JdRequestBase<SellerPromotionV2UnitBeanrequiredCreateResponse>
    {
                                                                                                                                                                                                                public  		string
              ip
 {get; set;}
 ...
 {get; set;}
  ...
  promoPrice {get; set; }
            ...
            {
                get{return "jingdong.seller.promotion.v2.unit.beanrequired.create";}
            }
