...
{
    public class AdsDspRtbKuaicheAccountDeliveryReportRequest : JdRequestBase<AdsDspRtbKuaicheAccountDeliveryReportResponse>
    {
                                                                                                                                              public  		string
              pageSize
 {get; set;}
 ...
 {get; set;}
            ...
            {
                get{return "jingdong.ads.dsp.rtb.kuaiche.accountDeliveryReport";}
            }
            protected override void PrepareParam(IDictionary<String, Object> parameters)
            {
                                                                                                        ...
                                                                                                        parameters.Add("matchingType", this.            matchingType
);
                                                                                                                                                                                                                                                                                                                                            }
    }
}
