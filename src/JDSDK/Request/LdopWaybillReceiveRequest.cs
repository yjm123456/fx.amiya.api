...
{
    public class LdopWaybillReceiveRequest : JdRequestBase<LdopWaybillReceiveResponse>
    {
                                                                                                                                                                               public  		string
              salePlat
 {get; set;}
 ...
 {get; set;}
  ...
  customerBoxNumber {get; set; }
            ...
            {
                get{return "jingdong.ldop.waybill.receive";}
            }
            protected override void PrepareParam(IDictionary<String, Object> parameters)
            {
                                                                                                        ...
                                                                                                        parameters.Add("unpackingInspection", this.            unpackingInspection
                                                                                                                                                ...
                                                                                                                                                parameters.Add("boxCode", this.            boxCode
);
