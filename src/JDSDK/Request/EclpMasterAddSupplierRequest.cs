...
{
    public class EclpMasterAddSupplierRequest : JdRequestBase<EclpMasterAddSupplierResponse>
    {
                                                                                                                                              public  		string
              deptNo
 {get; set;}
 ...
 {get; set;}
  ...
  pictureUrls {get; set; }
            ...
            {
                get{return "jingdong.eclp.master.addSupplier";}
            }
            protected override void PrepareParam(IDictionary<String, Object> parameters)
            {
                                                                                                        ...
                                                                                                        parameters.Add("ext5", this.            ext5
                                                                                                                                                ...
                                                                                                                                                parameters.Add("pictureUrls", this.            pictureUrls
);
                                                                                                                                                    }
    }
}
