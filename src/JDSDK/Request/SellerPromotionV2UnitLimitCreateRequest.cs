...
{
    public class SellerPromotionV2UnitLimitCreateRequest : JdRequestBase<SellerPromotionV2UnitLimitCreateResponse>
    {
                                                                                                                                                                                                                public  		string
              ip
 {get; set;}
 ...
 {get; set;}
  ...
  limitNum {get; set; }
            ...
            {
                get{return "jingdong.seller.promotion.v2.unit.limit.create";}
            }
