    ...
    public class EmployeePerformanceTargetController : ControllerBase
    {
        ...
        public async Task<ResultData> AddAsync(AddEmployeePerformanceTargetVo addVo)
        {
            try
            {
                ...
                addDto.EffectiveConsulationCardTarget = addVo.EffectiveConsulationCardTarget;
                addDto.PotentialConsulationCardTarget = addVo.PotentialConsulationCardTarget;
        ...
        public async Task<ResultData<EmployeePerformanceTargetVo>> GetByIdAsync(string id)
        {
            try
            {
                ...
                employeePerformanceTargetVo.EffectiveAddWechatTarget = employeePerformanceTarget.EffectiveAddWechatTarget;
                employeePerformanceTargetVo.PotentialAddWechatTarget = employeePerformanceTarget.PotentialAddWechatTarget;
        ...
        public async Task<ResultData> UpdateAsync(UpdateEmployeePerformanceTargetVo updateVo)
        {
            try
            {
                ...
                updateDto.EffectiveConsulationCardTarget = updateVo.EffectiveConsulationCardTarget;
                updateDto.PotentialConsulationCardTarget = updateVo.PotentialConsulationCardTarget;
