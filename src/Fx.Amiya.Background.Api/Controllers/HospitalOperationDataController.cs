    ...
    public class HospitalOperationDataController : ControllerBase
    {
        ...
        public async Task<ResultData<HospitalOperationDataListVo>> GetDataListAsync(string indicatorsId, int hospitalId)
        {
            try
            {
                ...
                hospitalOperationDataListVo.LastMonthNewCustomerPerformance = data.LastMonthNewCustomerPerformance/1000m;
                hospitalOperationDataListVo.LastMonthNewCustomerUnitPrice = data.LastMonthNewCustomerUnitPrice/1000m;
                ...
                hospitalOperationDataListVo.LastMonthOldCustomerPerformance = data.LastMonthOldCustomerPerformance/1000m;
                hospitalOperationDataListVo.LastMonthOldCustomerUnitPrice = data.LastMonthOldCustomerUnitPrice/1000m;
                hospitalOperationDataListVo.LastMonthTotalPerformance = data.LastMonthTotalPerformance/1000m;
                ...
                hospitalOperationDataListVo.ThisMonthNewCustomerPerformance = data.ThisMonthNewCustomerPerformance/1000m;
                hospitalOperationDataListVo.ThisMonthNewCustomerUnitPrice = data.ThisMonthNewCustomerUnitPrice/1000m;
                ...
                hospitalOperationDataListVo.ThisMonthOldCustomerPerformance = data.ThisMonthOldCustomerPerformance/1000m;
                hospitalOperationDataListVo.ThisMonthOldCustomerUnitPrice = data.ThisMonthOldCustomerUnitPrice/1000m;
                hospitalOperationDataListVo.ThisMonthTotalPerformance = data.ThisMonthTotalPerformance/1000m;
