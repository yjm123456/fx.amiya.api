...
namespace Fx.Amiya.Background.Api.Controllers
{
    ...
    public class TikTokOrderController : ControllerBase
    {
        ...
        {
            var order = await tikTokOrderInfoService.GetOrderById(orderId);
        ...
        {
            TikTokOrderInfoUpdateDto tikTokOrderInfoUpdateDto = new TikTokOrderInfoUpdateDto();
            tikTokOrderInfoUpdateDto.Id = tikTokOrderInfoUpdateVo.Id;
            tikTokOrderInfoUpdateDto.Phone = tikTokOrderInfoUpdateVo.Phone;
            tikTokOrderInfoUpdateDto.NickName = tikTokOrderInfoUpdateVo.NickName;
            await tikTokOrderService.UpdateOrderAsync(tikTokOrderInfoUpdateDto);
            return ResultData.Success();
        }*/
