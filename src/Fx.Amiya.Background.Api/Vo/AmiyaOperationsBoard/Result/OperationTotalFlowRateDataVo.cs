...
namespace Fx.Amiya.Background.Api.Vo.AmiyaOperationsBoard.Result
{
    public class OperationTotalFlowRateDataVo
    {
        ...
        /// 直播前线索折线图
        /// </summary>
        public List<PerformanceBrokenLineListInfoVo> BeforeLivingClueBrokenLineList { get; set; }
        /// <summary>
        /// 直播中线索折线图
        /// </summary>
        public List<PerformanceBrokenLineListInfoVo> LivingClueBrokenLineList { get; set; }
        /// <summary>
        /// 直播后线索折线图
        /// </summary>
        public List<PerformanceBrokenLineListInfoVo> AfterLivingClueBrokenLineList { get; set; }
    }
}
