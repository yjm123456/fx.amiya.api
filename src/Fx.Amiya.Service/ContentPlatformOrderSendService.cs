        ...
        public async Task<FxPageInfo<SimpleSendOrderInfoDto>> GetSendOrderInfoListByContentplateformIdAsync(QuerySendOrderInfoListDto query)
        {
            ...
            var res = _dalContentPlatformOrderSend.GetAll()
                      ...
                      .Select(e => new SimpleSendOrderInfoDto
                      {
                          ...
                          OrderStatusText = query.Area == (int)Area.China ? ServiceClass.GetContentPlateFormOrderStatusText(Convert.ToByte(e.OrderStatus)) : ServiceClassEnglishVersion.GetContentPlateFormOrderStatusTextEnglish(Convert.ToByte(e.OrderStatus)),
                          SendBy = e.Sender,
