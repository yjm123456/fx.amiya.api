...
namespace Fx.Amiya.Service
{
    public class CooperateLiveAnchorAchievementService : ICooperateLiveAnchorAchievementService
    {
        ...
        /// <returns></returns>
        public async Task<List<CooperateLiveAnchorAchievementDto>> GetCooperateLiveAnchorAchievementAsync(QueryCooperateLiveAnchorAchievementDto query)
        {
            ...
            var sequentialDate = DateTimeExtension.GetSequentialDateByStartAndEndDate(query.Year, query.Month);
            ...
            return performanceData.OrderByDescending(e => e.Performance).ToList();
        }
        /// <summary>
        /// 获取合作达人机构业绩
        /// </summary>
        ...
        public async Task<List<CooperateLiveAnchorHospitalAchievementDto>> GetCooperateLiveAnchorHospitalAchieementsAsync(QueryCooperateLiveAnchorAchievementDto query)
        {
            var baseLiveAnchorIds = await liveAnchorBaseInfoService.GetCooperateLiveAnchorAsync(null);
            var liveAnchorIds = await liveAnchorService.GetLiveAnchorListByBaseInfoIdListAsync(baseLiveAnchorIds.Select(e => e.Id).ToList());
            var sequentialDate = DateTimeExtension.GetSequentialDateByStartAndEndDate(query.Year, query.Month);
