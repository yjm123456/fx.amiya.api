...
namespace Fx.Amiya.Service
{
    public class TikTokUserInfoService : ITikTokUserInfoService
    {
        ...
        public TikTokUserInfoService(IDalTikTokUserInfo dalTikTokUserInfo, IOrderAppInfoService orderAppInfoService, IDalCustomerBaseInfo dalCustomerBaseInfo, IDalTikTokOrderInfo dalTikTokOrderInfo)
        {
