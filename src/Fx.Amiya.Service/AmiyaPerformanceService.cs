...
namespace Fx.Amiya.Service
{
    public class AmiyaPerformanceService : IAmiyaPerformanceService
    {
        ...
        /// <returns></returns>
        public async Task<AmiyaOperationDataDto> GetPerformanceOperationDataAsync(int year, int month, string contentPlatFormId, bool? isEffectiveCustomerData, string liveAnchorBaseId)
        {
            ...
            //小黄车数据
            var baseBusinessPerformance = await shoppingCartRegistrationService.GetNewBaseBusinessPerformanceByLiveAnchorNameAsync(sequentialDate.StartDate, sequentialDate.EndDate, isEffectiveCustomerData, contentPlatFormId, liveAnchorBaseId);
            //上月的小黄车数据
            ...
            //线索有效率
            newCustomerOperationDataDto.ClueEffictiveRate = CalculateTargetComplete(consulationdetails.Value, addCarddetails.Value);
            newCustomerOperationDataDto.ClueEffictiveRateHealthValueThisMonth = await healthValueService.GetValueByCode("ClueEffictiveRateHealthValueThisMonth");
            #endregion
            ...
            oldCustomerOperationDataDto.SecondTimeBuyRateProportion = CalculateTargetComplete(Convert.ToDecimal(oldCustomerOperationDataDto.SecondDealPeople), Convert.ToDecimal(oldCustomerOperationDataDto.TotalDealPeople)).Value; ;
        ...
        public async Task<CompanyMonthPerformanceBWDto> GetMonthPerformanceAsync(int year, int month)
        {
            ...
            var selfLiveAnchorNewPerformanceYearOnYear = selfLiveAnchorOrderYearOnYear.Where(x => x.IsOldCustomer == false).Sum(o => o.Price);
            var selfLiveAnchorOldPerformanceYearOnYear = selfLiveAnchorOrderYearOnYear.Where(x => x.IsOldCustomer == true).Sum(o => o.Price);
            ...
            var selfLiveAnchorNewPerformanceChainRatio = selfLiveAnchorOrderChain.Where(x => x.IsOldCustomer == false).Sum(o => o.Price);
            var selfLiveAnchorOldPerformanceChainRatio = selfLiveAnchorOrderChain.Where(x => x.IsOldCustomer == true).Sum(o => o.Price);
            ...
            var otherLiveAnchorNewPerformanceYearOnYear = otherLiveAnchorOrderYearOnYear.Where(x => x.IsOldCustomer == false).Sum(o => o.Price);
            var otherLiveAnchorOldPerformanceYearOnYear = otherLiveAnchorOrderYearOnYear.Where(x => x.IsOldCustomer == true).Sum(o => o.Price);
            ...
            var otherLiveAnchorNewPerformanceChainRatio = otherLiveAnchorOrderChain.Where(x => x.IsOldCustomer == false).Sum(o => o.Price);
            var otherLiveAnchorOldPerformanceChainRatio = otherLiveAnchorOrderChain.Where(x => x.IsOldCustomer == true).Sum(o => o.Price);
            ...
            var DoctorNewPerformanceYearOnYear = DoctorOrderYearOnYear.Where(x => x.IsOldCustomer == false).Sum(o => o.Price);
            var DoctorOldPerformanceYearOnYear = DoctorOrderYearOnYear.Where(x => x.IsOldCustomer == true).Sum(o => o.Price);
            ...
            var DoctorNewPerformanceChainRatio = DoctorOrderChain.Where(x => x.IsOldCustomer == false).Sum(o => o.Price);
            var DoctorOldPerformanceChainRatio = DoctorOrderChain.Where(x => x.IsOldCustomer == true).Sum(o => o.Price);
            ...
            var newCustomerPerformance = Math.Round(curSelfLiveAnchorNewCustomerPerformance + curOtherLiveAnchorNewCustomerPerformance + curDoctorNewCustomerPerformance, MidpointRounding.AwayFromZero);
            var oldCustomerPerformance = Math.Round(curSelfLiveAnchorOldCustomerPerformance + curOtherLiveAnchorOldCustomerPerformance + curDoctorOldCustomerPerformance, MidpointRounding.AwayFromZero);
            ...
            CompanyMonthPerformanceBWDto monthPerformanceRatioDto = new CompanyMonthPerformanceBWDto
            {
                ...
                SelfLiveAnchorNewCustomerPerformanceCompleteRate = CalculateTargetComplete(curSelfLiveAnchorNewCustomerPerformance, selfLiveAnchortarget.NewCustomerPerformanceTarget),
                SelfLiveAnchorOldCustomerPerformanceCompleteRate = CalculateTargetComplete(curSelfLiveAnchorOldCustomerPerformance, selfLiveAnchortarget.OldCustomerPerformanceTarget),
                SelfLiveAnchorNewCustomerPerformanceYearToYear = CalculateYearOnYear(curSelfLiveAnchorNewCustomerPerformance, selfLiveAnchorNewPerformanceYearOnYear),
                SelfLiveAnchorNewCustomerPerformanceChainRatio = CalculateChainratio(curSelfLiveAnchorNewCustomerPerformance, selfLiveAnchorNewPerformanceChainRatio),
                SelfLiveAnchorOldCustomerPerformanceYearToYear = CalculateYearOnYear(curSelfLiveAnchorOldCustomerPerformance, selfLiveAnchorOldPerformanceYearOnYear),
                SelfLiveAnchorOldCustomerPerformanceChainRatio = CalculateChainratio(curSelfLiveAnchorOldCustomerPerformance, selfLiveAnchorOldPerformanceChainRatio),
                ...
                OtherLiveAnchorNewCustomerPerformanceCompleteRate = CalculateTargetComplete(curOtherLiveAnchorNewCustomerPerformance, otherLiveAnchortarget.NewCustomerPerformanceTarget),
                OtherLiveAnchorOldCustomerPerformanceCompleteRate = CalculateTargetComplete(curOtherLiveAnchorOldCustomerPerformance, otherLiveAnchortarget.OldCustomerPerformanceTarget),
                OtherLiveAnchorNewCustomerPerformanceYearToYear = CalculateYearOnYear(curOtherLiveAnchorNewCustomerPerformance, otherLiveAnchorNewPerformanceYearOnYear),
                OtherLiveAnchorNewCustomerPerformanceChainRatio = CalculateChainratio(curOtherLiveAnchorNewCustomerPerformance, otherLiveAnchorNewPerformanceChainRatio),
                OtherLiveAnchorOldCustomerPerformanceYearToYear = CalculateYearOnYear(curOtherLiveAnchorOldCustomerPerformance, otherLiveAnchorOldPerformanceYearOnYear),
                OtherLiveAnchorOldCustomerPerformanceChainRatio = CalculateChainratio(curOtherLiveAnchorOldCustomerPerformance, otherLiveAnchorOldPerformanceChainRatio),
                ...
                DoctorNewCustomerPerformanceCompleteRate = 0.00M,
                DoctorOldCustomerPerformanceCompleteRate = 0.00M,
                DoctorNewCustomerPerformanceYearToYear = CalculateYearOnYear(curDoctorNewCustomerPerformance, DoctorNewPerformanceYearOnYear),
                DoctorNewCustomerPerformanceChainRatio = CalculateChainratio(curDoctorNewCustomerPerformance, DoctorNewPerformanceChainRatio),
                DoctorOldCustomerPerformanceYearToYear = CalculateYearOnYear(curDoctorOldCustomerPerformance, DoctorOldPerformanceYearOnYear),
                DoctorOldCustomerPerformanceChainRatio = CalculateChainratio(curDoctorOldCustomerPerformance, DoctorOldPerformanceChainRatio),
                ...
                OldCustomerPerformance = oldCustomerPerformance,
        ...
        /// <param name="liveAnchorBaseId">主播基础id</param>
        /// <param name="isSelfLiveAnchor">是否为自播达人</param>
        /// <returns></returns>
        public async Task<LiveAnchorMonthAndDatePerformanceDto> GetMonthPerformanceBySelfLiveAnchorAsync(DateTime date, string liveAnchorBaseId, bool? isSelfLiveAnchor)
        {
            var sequentialDate = DateTimeExtension.GetSequentialDateByStartAndEndDate(date.Year, date.Month);
            //获取各个平台的主播ID
            var LiveAnchorInfo = await this.GetLiveAnchorIdsByBaseIdAndIsSelfLiveAnchorAsync(liveAnchorBaseId, isSelfLiveAnchor);
            //获取目标
            var target = await liveAnchorMonthlyTargetAfterLivingService.GetPerformance(date.Year, date.Month, LiveAnchorInfo);
            //获取月份内天数，用于拆解算出当日目标值
            int days = DateTime.DaysInMonth(date.Year, date.Month);
            //拼接选中时间的开始与结束时间
            var todayDate = DateTimeExtension.GetChooseDateStartDateAndEndDate(date);
            ...
            //当日总业绩
            var todayOrder = await contentPlatFormOrderDealInfoService.GetPerformanceByDateAsync(todayDate.StartDate, todayDate.EndDate, LiveAnchorInfo);
            var curTodayTotalPerformance = todayOrder.Sum(o => o.Price);

            //当日同比业绩
            var todayOrderYearOnYear = await contentPlatFormOrderDealInfoService.GetPerformanceByDateAsync(todayDate.LastYearThisMonthStartDate, todayDate.LastYearThisMonthEndDate, LiveAnchorInfo);
            var todayTotalPerformanceYearOnYear = todayOrderYearOnYear.Sum(o => o.Price);

            //当日环比业绩
            var todayOrderChain = await contentPlatFormOrderDealInfoService.GetPerformanceByDateAsync(todayDate.LastMonthStartDate, todayDate.LastMonthEndDate, LiveAnchorInfo);
            var todayTotalPerformanceChainRatio = todayOrderChain.Sum(o => o.Price);
            #endregion
            ...
            ////当日视频业绩
            //var curTodayVideoPerformance = todayOrder.Where(o => o.ConsultationType == (int)ContentPlateFormOrderConsultationType.Collaboration).Sum(o => o.Price);
            #endregion
            ...
            ////当日照片业绩
            //var curTodayPicturePerformance = todayOrder.Where(o => o.ConsultationType == (int)ContentPlateFormOrderConsultationType.IndependentFollowUp).Sum(o => o.Price);
            #endregion
            ...
            ////当日主播接诊业绩
            //var curTodayLiveAnchorAcompanyingPerformance = todayOrder.Where(o => o.IsAcompanying == true).Sum(o => o.Price);
            #endregion
            ...
            //当日有效业绩
            var curTodayHavingPricePerformance = todayOrder.Where(o => o.AddOrderPrice > 0).Sum(o => o.Price);
            var todayHavingPriceYearOnYearr = todayOrderYearOnYear.Where(x => x.AddOrderPrice > 0).ToList();
            var todayHavingPricePerformanceYearOnYear = todayHavingPriceYearOnYearr.Sum(o => o.Price);
            var todayHavingPriceOrderChainRatio = todayOrderChain.Where(x => x.AddOrderPrice > 0).ToList();
            var todayHavingPricePerformanceRatio = todayHavingPriceOrderChainRatio.Sum(o => o.Price);
            ...
            //当日有效负数业绩相加
            curTodayHavingPricePerformance += todayOrder.Where(o => o.AddOrderPrice < 0).Sum(o => o.Price);
            todayHavingPricePerformanceYearOnYear += todayOrderYearOnYear.Where(x => x.AddOrderPrice < 0).Sum(o => o.Price);
            todayHavingPricePerformanceRatio += todayOrderChain.Where(x => x.AddOrderPrice < 0).Sum(o => o.Price);
            #endregion
            ...
            //当日潜在业绩
            var curTodayNotHavePricePerformance = todayOrder.Where(o => o.AddOrderPrice == 0).Sum(o => o.Price);

            var curTodayNotHavePriceYearOnYearr = todayOrderYearOnYear.Where(x => x.AddOrderPrice == 0).ToList();
            var curTodayNotHavePricePerformanceYearOnYear = curTodayNotHavePriceYearOnYearr.Sum(o => o.Price);
            var curTodayNotHavePriceOrderChainRatio = todayOrderChain.Where(x => x.AddOrderPrice == 0).ToList();
            var curTodayNotHavePricePerformanceRatio = curTodayNotHavePriceOrderChainRatio.Sum(o => o.Price);
            #endregion
            ...
            MonthPerformanceBWDto datePerformanceRatioDto = new MonthPerformanceBWDto
            {
                CueerntMonthTotalPerformance = DecimalExtension.ChangePriceToTenThousand(curTodayTotalPerformance),
                TotalPerformanceTarget = DecimalExtension.ChangePriceToTenThousand(target.TotalPerformanceTarget / days),
                TotalPerformanceTargetComplete = CalculateTargetComplete(curTodayTotalPerformance, target.TotalPerformanceTarget / days),
                TotalPerformanceYearOnYear = CalculateYearOnYear(curTodayTotalPerformance, todayTotalPerformanceYearOnYear),
                TotalPerformanceChainratio = CalculateChainratio(curTodayTotalPerformance, todayTotalPerformanceChainRatio),

                CurrentMonthNewCustomerPerformance = DecimalExtension.ChangePriceToTenThousand(curTodayNewCustomer),
                NewCustomerPerformanceRatio = CalculateTargetComplete(curTodayNewCustomer, curTodayTotalPerformance),
                NewCustomerPerformanceYearOnYear = CalculateYearOnYear(curTodayNewCustomer, todayNewPerformanceYearOnYear),
                NewCustomerPerformanceChainRatio = CalculateChainratio(curTodayNewCustomer, todayNewPerformanceChainRatio),
                NewCustomerPerformanceTarget = DecimalExtension.ChangePriceToTenThousand(target.NewCustomerPerformanceTarget / days),
                NewCustomerPerformanceTargetComplete = CalculateTargetComplete(curTodayNewCustomer, target.NewCustomerPerformanceTarget / days),

                CurrentMonthOldCustomerPerformance = DecimalExtension.ChangePriceToTenThousand(curTodayOldCustomer),
                OldCustomerPerformanceRatio = CalculateTargetComplete(curTodayOldCustomer, curTodayTotalPerformance),
                OldCustomerPerformanceYearOnYear = CalculateYearOnYear(curTodayOldCustomer, todayOldPerformanceYearOnYear),
                OldCustomerPerformanceChainRatio = CalculateChainratio(curTodayOldCustomer, todayOldPerformanceChainRatio),
                OldCustomerTarget = DecimalExtension.ChangePriceToTenThousand(target.OldCustomerPerformanceTarget / days),
                OldCustomerTargetComplete = CalculateTargetComplete(curTodayOldCustomer, target.OldCustomerPerformanceTarget / days),


                //PictureConsultationPerformance = DecimalExtension.ChangePriceToTenThousand(curTodayPicturePerformance),
                //PictureConsultationPerformanceRatio = CalculateTargetComplete(curTodayPicturePerformance, curTodayTotalPerformance),

                //VideoConsultationPerformance = DecimalExtension.ChangePriceToTenThousand(curTodayVideoPerformance),
                //VideoConsultationPerformanceRatio = CalculateTargetComplete(curTodayVideoPerformance, curTodayTotalPerformance),


                //AcompanyingPerformance = DecimalExtension.ChangePriceToTenThousand(curTodayLiveAnchorAcompanyingPerformance),
                //AcompanyingPerformanceRatio = CalculateTargetComplete(curTodayLiveAnchorAcompanyingPerformance, curTodayTotalPerformance),


                //NotAcompanyingPerformance = DecimalExtension.ChangePriceToTenThousand(curTodayNotLiveAnchorAcompanyingPerformance),
                //NotAcompanyingPerformanceRatio = CalculateTargetComplete(curTodayNotLiveAnchorAcompanyingPerformance, curTodayTotalPerformance),


                ZeroPricePerformance = DecimalExtension.ChangePriceToTenThousand(curTodayNotHavePricePerformance),
                ZeroPricePerformanceRatio = CalculateTargetComplete(curTodayNotHavePricePerformance, curTodayTotalPerformance),
                ZeroPricePerformanceYearOnYear = CalculateYearOnYear(curTodayNotHavePricePerformance, curTodayNotHavePricePerformanceYearOnYear),
                ZeroPricePerformanceChainRatio = CalculateChainratio(curTodayNotHavePricePerformance, curTodayNotHavePricePerformanceRatio),


                ExistPricePerformance = DecimalExtension.ChangePriceToTenThousand(curTodayHavingPricePerformance),
                ExistPricePerformanceRatio = CalculateTargetComplete(curTodayHavingPricePerformance, curTodayTotalPerformance),
                ExistPricePerformanceYearOnYear = CalculateYearOnYear(curTodayHavingPricePerformance, todayHavingPricePerformanceYearOnYear),
                ExistPricePerformanceChainRatio = CalculateChainratio(curTodayHavingPricePerformance, todayHavingPricePerformanceRatio),


                //DuringMonthSendDuringMonthDeal = DecimalExtension.ChangePriceToTenThousand(thisMonthTodaySendAndDealPerformance),
                //DuringMonthSendDuringMonthDealPerformanceRatio = CalculateTargetComplete(thisMonthTodaySendAndDealPerformance, curTodayTotalPerformance),

                //HistorySendDuringMonthDeal = DecimalExtension.ChangePriceToTenThousand(historyMonthTodaySendAndDealPerformance),
                //HistorySendDuringMonthDealPerformanceRatio = CalculateTargetComplete(historyMonthTodaySendAndDealPerformance, curTodayTotalPerformance),

            };

            LiveAnchorMonthAndDatePerformanceDto liveAnchorMonthAndDatePerformanceDto = new LiveAnchorMonthAndDatePerformanceDto();
            liveAnchorMonthAndDatePerformanceDto.MonthDataVo = monthPerformanceRatioDto;
            liveAnchorMonthAndDatePerformanceDto.CurrentDateDataVo = datePerformanceRatioDto;
            return liveAnchorMonthAndDatePerformanceDto;
        }
        ...
        public async Task<List<CustomerPerformanceBWDto>> GetBelongCustomerServicePerformanceByLiveAnchorBaseIdAsync(int year, int month, string liveAnchorBaseId)
        {
            ...
            //数据组合
            var visitNumHealthValue = await healthValueService.GetValueByCode("ToHospitalRateHealthValueThisMonth");
            var dealNumHealthValue = await healthValueService.GetValueByCode("DealRateHealthValueThisMonth");
            var buyAgainNumHealthValue = await healthValueService.GetValueByCode("ThisMonthRepeateBuyRate");
            var monthPerformanceRatioDto = from d in dealInfo
                                           select new CustomerPerformanceBWDto()
                                           {
                                               ...
                                               VisitNumHealthNumber = visitNumHealthValue,
                                               DealNumHealthNumber = dealNumHealthValue,
                                               BuyAgainNumHealthNumber = buyAgainNumHealthValue,
                                           };

            var result = monthPerformanceRatioDto.ToList();
            return result;
        }
        ...
        public async Task<AmiyaAchievementBrokenLineListDto> GetAmiyaAchievementBrokenLineListDataAsync(string baseLiveanchorId, int year, int month)
        {
            ...
            amiyaAchievementDetailDataDto.NewCustomerPerformanceBrokenLineList = this.FillDate(type, year, month, dataList).Select(e => new PerformanceBrokenLineListInfoDto { date = e.Time.ToString(), Performance = ChangePriceToTenThousand(e.NewCustomerPerformance) }).OrderBy(e => Convert.ToInt32(e.date)).ToList();
            amiyaAchievementDetailDataDto.OldCustomerPerformanceBrokenLineList = this.FillDate(type, year, month, dataList).Select(e => new PerformanceBrokenLineListInfoDto { date = e.Time.ToString(), Performance = ChangePriceToTenThousand(e.OldCustomerPerformance) }).OrderBy(e => Convert.ToInt32(e.date)).ToList();
            amiyaAchievementDetailDataDto.EffectivePerformanceBrokenLineList = this.FillDate(type, year, month, dataList).Select(e => new PerformanceBrokenLineListInfoDto { date = e.Time.ToString(), Performance = ChangePriceToTenThousand(e.EffectivePerformance) }).OrderBy(e => Convert.ToInt32(e.date)).ToList();
            amiyaAchievementDetailDataDto.PotentialPerformanceBrokenLineList = this.FillDate(type, year, month, dataList).Select(e => new PerformanceBrokenLineListInfoDto { date = e.Time.ToString(), Performance = ChangePriceToTenThousand(e.PotentialPerformance) }).OrderBy(e => Convert.ToInt32(e.date)).ToList();
            amiyaAchievementDetailDataDto.ThisMonthSendOrderPerformanceBrokenLineList = this.FillDate(type, year, month, dataList).Select(e => new PerformanceBrokenLineListInfoDto { date = e.Time.ToString(), Performance = ChangePriceToTenThousand(e.ThisMonthSendOrderPerformance) }).OrderBy(e => Convert.ToInt32(e.date)).ToList();
            amiyaAchievementDetailDataDto.HistorySendOrderPerformanceBrokenLineList = this.FillDate(type, year, month, dataList).Select(e => new PerformanceBrokenLineListInfoDto { date = e.Time.ToString(), Performance = ChangePriceToTenThousand(e.HistorySendOrderPerformance) }).OrderBy(e => Convert.ToInt32(e.date)).ToList();
            amiyaAchievementDetailDataDto.TikTokPerformanceBrokenLineList = this.FillDate(type, year, month, dataList).Select(e => new PerformanceBrokenLineListInfoDto { date = e.Time.ToString(), Performance = ChangePriceToTenThousand(e.TikTokPerformance) }).OrderBy(e => Convert.ToInt32(e.date)).ToList();
            amiyaAchievementDetailDataDto.VideoPerformanceBrokenLineList = this.FillDate(type, year, month, dataList).Select(e => new PerformanceBrokenLineListInfoDto { date = e.Time.ToString(), Performance = ChangePriceToTenThousand(e.VideoPerformance) }).OrderBy(e => Convert.ToInt32(e.date)).ToList();
            amiyaAchievementDetailDataDto.LiveAnchorVideoPerformanceBrokenLineList = this.FillDate(type, year, month, dataList).Select(e => new PerformanceBrokenLineListInfoDto { date = e.Time.ToString(), Performance = ChangePriceToTenThousand(e.LiveAnchorVideoPerformance) }).OrderBy(e => Convert.ToInt32(e.date)).ToList();
            amiyaAchievementDetailDataDto.AssistantPhotoPerformanceBrokenLineList = this.FillDate(type, year, month, dataList).Select(e => new PerformanceBrokenLineListInfoDto { date = e.Time.ToString(), Performance = ChangePriceToTenThousand(e.AssistantPhotoPerformance) }).OrderBy(e => Convert.ToInt32(e.date)).ToList();
            amiyaAchievementDetailDataDto.LiveAnchorReceptionPerformanceBrokenLineList = this.FillDate(type, year, month, dataList).Select(e => new PerformanceBrokenLineListInfoDto { date = e.Time.ToString(), Performance = ChangePriceToTenThousand(e.LiveAnchorReceptionPerformance) }).OrderBy(e => Convert.ToInt32(e.date)).ToList();
            amiyaAchievementDetailDataDto.NoLiveAnchorReceptionPerformanceBrokenLineList = this.FillDate(type, year, month, dataList).Select(e => new PerformanceBrokenLineListInfoDto { date = e.Time.ToString(), Performance = ChangePriceToTenThousand(e.NoLiveAnchorReceptionPerformance) }).OrderBy(e => Convert.ToInt32(e.date)).ToList();
            return amiyaAchievementDetailDataDto;
        }
        /// <summary>
        /// 计算金额类数值以万展示
