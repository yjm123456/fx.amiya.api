...
namespace Fx.Amiya.Service
{
    public class FinancialboardService : IFinancialboardService
    {
        ...
        /// <returns></returns>
        public async Task<List<LiveAnchorBoardDataDto>> GetBoardLiveAnchorDataAsync(DateTime? startDate, DateTime? endDate, int? liveAnchorId)
        {
            ...
            var contentPlatFormOrderDataList = await contentPlateFormOrderService.GetLiveAnchorPriceByLiveAnchorIdAsync(startDate, endDate, liveAnchorId);
            ...
            liveAnchorBoardDataList.AddRange(contentPlatFormOrderDataList);
