...
namespace Fx.Amiya.IService
{
    public interface IContentPlatformOrderSendService
    {
        ...
        /// <param name="hospitalId"></param>
        /// <returns></returns>
        Task<int> GetCountByHospitalIdAsync(int hospitalId, bool isSpecifyHospitalEmployee, int hospitalEmpId);
        ...
        /// <returns></returns>
        Task<List<SendContentPlatFormOrderReportDto>> GetContentPlatFormHospitalOrderReportAsync(DateTime? startDate, DateTime? endDate, int? orderStatus, int hospitalId, bool isHidePhone, bool isSpecifyHospitalEmployee, int hospitalEmpId);
        ...
        /// <param name="endDate"></param>
        /// <returns></returns>
        Task<List<SendContentPlatformOrderDto>> GetOrderToHospitalDataByDateAsync(DateTime startDate, List<int> liveAnchorIds);
