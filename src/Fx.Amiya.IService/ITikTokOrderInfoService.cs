...
namespace Fx.Amiya.IService
{
    public interface ITikTokOrderInfoService
    {
        ...
        /// <returns></returns>
        Task<FxPageInfo<TikTokOrderDto>> GetOrderListWithPageAsync(DateTime? startDate, DateTime? endDate, long? orderType, string keyword, int belongLiveAnchorId, string statusCode, int pageNum, int pageSize);
