...
namespace Fx.Amiya.IService
{
    public interface IContentPlateFormOrderService
    {
        ...
        /// <param name="pageSize"></param>
        /// <returns></returns>
        Task<FxPageInfo<ContentPlatFormOrderInfoDto>> GetOrderDealListWithPageAsync(int? liveAnchorId, DateTime? startDate, DateTime? endDate, int? consultationEmpId, int? checkState, bool? ReturnBackPriceState, string keyword, string contentPlateFormId, int? hospitalId, int employeeId, int pageNum, int pageSize);
        ...
        /// <returns></returns>
        Task<List<ContentPlatFormOrderInfoDto>> GetOrderDealAsync(DateTime? startDate, DateTime? endDate, int? dealHospitalId, int? checkState, int? liveAnchorId, bool hidePhone);
