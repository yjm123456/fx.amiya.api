...
namespace Fx.Amiya.IService
{
    public interface IContentPlatFormOrderDealInfoService
    {
        ...
        Task<FxPageInfo<ContentPlatFormOrderDealInfoDto>> GetListWithPageAsync(string contentPlafFormOrderId, int pageNum, int pageSize,int area);
        /// <summary>
        /// 医院端获取成交情况
        /// </summary>
        ...
        Task<List<ContentPlatFormOrderDealInfoDto>> GetTodaySendPerformanceByHospitalIdAsync(List<int> hospitalId, DateTime startDate, DateTime endDate);
        /// <summary>
        ...
        /// <returns></returns>
        Task<List<ContentPlatFormOrderDealInfoDto>> GeVisitAndDealNumByHospitalIdAndPhoneListAsync(List<int> hospitalIds, DateTime recordStartDate, DateTime recordEndDate, List<string> phoneList);
        /// <summary>
        /// 根据到院id和时间获取指定月份成交量
        /// </summary>
        /// <param name="hospitalId"></param>
