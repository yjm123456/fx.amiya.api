...
namespace Fx.Amiya.Dto.AmiyaHospitalOperation.Result
{
    ...
    /// 机构新老客业绩漏斗图
    /// </summary>
    public class HospitalNewOrOldCustomerDataDto
    {

        /// <summary>
        /// 新客业绩
        /// </summary>
        public HospitalNewCustomerOperationDataDto NewCustomerData { get; set; }
        /// <summary>
        /// 老客业绩
        /// </summary>

        public HospitalOldCustomerOperationDataDto OldCustomerData { get; set; }
    }
    ...
    /// 新客业绩输出类
    /// </summary>
    public class HospitalNewCustomerOperationDataDto
    {
        ...
        /// 漏斗图详情数据
        /// </summary>
        public List<HospitalNewCustomerOperationDataDetailsDto> newCustomerOperationDataDetails { get; set; }
    ...
    /// 老客业绩输出类
    /// </summary>
    public class HospitalOldCustomerOperationDataDto
    {
        /// <summary>
        /// 总成交人数
        /// </summary>
    ...
    /// 业绩输出详情
    /// </summary>
    public class HospitalNewCustomerOperationDataDetailsDto
    {
        /// <summary>
        /// 标识码
        /// </summary>
