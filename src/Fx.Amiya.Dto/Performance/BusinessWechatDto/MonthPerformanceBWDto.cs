...
{
    public class LiveAnchorMonthAndDatePerformanceDto
    {
        /// <summary>
        /// 月数据
        /// </summary>
        public MonthPerformanceBWDto MonthDataVo { get; set; }
        /// <summary>
        /// 日数据
        /// </summary>
        public MonthPerformanceBWDto CurrentDateDataVo { get; set; }
    }
