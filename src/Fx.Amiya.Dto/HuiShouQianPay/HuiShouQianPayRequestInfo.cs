...
namespace Fx.Amiya.Dto.HuiShouQianPay
{
    ...
    public class OffcialWebSiteHuiShouQianPayRequestInfo
    {
        //商户在支付平台创建生成的门店编号
        /*public string SubMerchantNo { get; private set; }*/
        //商户系统内部订单号，唯一不重复
        ...
        public string Extend { get; set; }
        //扩展信息 json格式
        public OfficialWebSiteHuiShouQianMemoInfo Memo { get; set; }
        public OffcialWebSiteHuiShouQianPayRequestInfo()
        {
            //正式环境
            this.ReturnUrl = string.Format("{0}/Notify/hsqPayResult", "https://app.ameiyes.com/amiyabg");
            //测试环境
            //this.ReturnUrl = string.Format("{0}/amiya/wxmini/Notify/hsqPayResult", "https://www.amyk.cn");
            //本地环境
            //this.ReturnUrl = string.Format("{0}/amiya/wxmini/Notify/hsqPayResult", "http://ymjxui.gnway.cc");
