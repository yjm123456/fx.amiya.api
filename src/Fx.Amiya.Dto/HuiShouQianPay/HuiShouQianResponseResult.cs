...
namespace Fx.Amiya.Dto.HuiShouQianPay
{
    ...
    public class OfficialWebsiteHuiShouQianCommonResponseResult
    {
        //服务端响应状态，如果为true，则可以调用result；如果为false，则调用errorCode来获取出错信息
        public string success { get; set; }
        /// <summary>
        ...
        /// 响应内容	
        /// </summary>
        public OfficialWebsiteHuiShouQianResponseResult result { get; set; }
        /// <summary>
        /// 签名数据	
        /// </summary>
        public string sign { get; set; }
    }
    public class OfficialWebsiteHuiShouQianResponseResult
    {
        /// <summary>
        /// 原样返回商户订单号	
        /// </summary>
