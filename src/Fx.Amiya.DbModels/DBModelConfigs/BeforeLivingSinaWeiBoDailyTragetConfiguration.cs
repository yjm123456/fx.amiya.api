...
namespace Fx.Amiya.DbModels.DBModelConfigs
{
    public class BeforeLivingSinaWeiBoDailyTargetConfiguration : IEntityTypeConfiguration<BeforeLivingSinaWeiBoDailyTarget>
    {
        ...
        {
            builder.ToTable("tbl_beforeliving_sina_weibo_daily_target");
            ...
            builder.HasOne(e => e.LiveAnchorMonthlyTarget).WithMany(e => e.beforeLivingSinaWeiBoDailyTarget).HasForeignKey(e => e.LiveAnchorMonthlyTargetId);
