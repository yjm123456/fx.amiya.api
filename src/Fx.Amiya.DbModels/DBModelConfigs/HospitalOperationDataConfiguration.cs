...
namespace Fx.Amiya.DbModels.DBModelConfigs
{
    public class HospitalOperationDataConfiguration : IEntityTypeConfiguration<HospitalOperationData>
    {
        public void Configure(EntityTypeBuilder<HospitalOperationData> builder)
        {
            ...
            builder.Property(t => t.OperationName).HasColumnName("OperationName").HasColumnType("varchar(100)").IsRequired();
            ...
            builder.Property(t => t.GreatHospital).HasColumnName("great_hospital").HasColumnType("varchar(100)").IsRequired();
