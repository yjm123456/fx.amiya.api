...
{
    public class LiveReplayProductDealDataConfiguration : IEntityTypeConfiguration<LiveReplayProductDealData>
    {
        public void Configure(EntityTypeBuilder<LiveReplayProductDealData> builder)
        {
            builder.ToTable("tbl_live_replay_product_deal_data");
            ...
            builder.HasOne(e => e.LiveReplay).WithMany(e => e.LiveReplayProductDealDataList).HasForeignKey(e => e.LiveReplayId);
        }
    }
}
