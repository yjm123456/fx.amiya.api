...
{
    public class TikTokOrderInfoConfiguration : IEntityTypeConfiguration<TikTokOrderInfo>
    {
        public void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<TikTokOrderInfo> builder)
        {
            builder.ToTable("tbl_tiktok_order_info");
            ...
            builder.Property(e => e.BelongLiveAnchorId).HasColumnName("belong_live_anchor_id").HasColumnType("varchar(50)").IsRequired(false);
