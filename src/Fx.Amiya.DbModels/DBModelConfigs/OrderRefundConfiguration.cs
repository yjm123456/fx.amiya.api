...
namespace Fx.Amiya.DbModels.DBModelConfigs
{
    public class OrderRefundConfiguration : IEntityTypeConfiguration<OrderRefund>
    {
        public void Configure(EntityTypeBuilder<OrderRefund> builder)
        {
            ...
            builder.Property(e => e.CheckState).HasColumnName("check_state").HasColumnType("bit").IsRequired();
            builder.Property(e => e.UncheckReason).HasColumnName("uncheck_reason").HasColumnType("varchar(500)").IsRequired(false);
            builder.Property(e => e.RefundState).HasColumnName("refund_state").HasColumnType("bit").IsRequired();
            ...
            builder.Property(e => e.ExchangeType).HasColumnName("exchange_type").HasColumnType("bit").IsRequired();
