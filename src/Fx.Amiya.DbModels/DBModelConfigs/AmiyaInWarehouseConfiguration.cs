...
{
    public class AmiyaInWarehouseConfiguration : IEntityTypeConfiguration<AmiyaInWarehouse>
    {
        public void Configure(EntityTypeBuilder<AmiyaInWarehouse> builder)
        {
            builder.ToTable("tbl_amiya_in_warehouse");
            ...
            builder.HasOne(e => e.WareHouseInfo).WithMany(e => e.AmiyaInWarehouseList).HasForeignKey(e => e.WareHouseId);
            builder.HasOne(e => e.Employee).WithMany(e => e.AmiyaInWarehouse).HasForeignKey(e => e.CreateBy);
        }
    }
}
