...
{
    public class ImprovePlanAndRemarkConfiguration : IEntityTypeConfiguration<ImprovePlanAndRemark>
    {
        public void Configure(EntityTypeBuilder<ImprovePlanAndRemark> builder)
        {
            builder.ToTable("tbl_improve_plan");
