...
namespace Fx.Amiya.DbModels.DBModelConfigs
{
    public class ItemInfoConfiguration : IEntityTypeConfiguration<ItemInfo>
    {
        public void Configure(EntityTypeBuilder<ItemInfo> builder)
        {
            ...
            builder.Property(t => t.SalePrice).HasColumnName("sale_price").HasColumnType("decimal(10,2)").IsRequired(false);
            ...
            builder.Property(t => t.ItemDetailsId).HasColumnName("item_details_id").HasColumnType("varchar(50)").IsRequired(false);
            ...
            builder.Property(t => t.OtherAppItemId).HasColumnName("other_app_item_id").HasColumnType("varchar(1000)").IsRequired(false);
