...
namespace Fx.Amiya.DbModels.DBModelConfigs
{
    public class BindCustomerServiceConfiguration : IEntityTypeConfiguration<BindCustomerService>
    {
        public void Configure(EntityTypeBuilder<BindCustomerService> builder)
        {
            ...
            builder.Property(t => t.SystemSendGiftTime).HasColumnName("system_send_gift_time").HasColumnType("int").IsRequired(false);
            builder.Property(t => t.NewSystemSendGiftDate).HasColumnName("new_system_send_gift_date").HasColumnType("datetime").IsRequired(false);
