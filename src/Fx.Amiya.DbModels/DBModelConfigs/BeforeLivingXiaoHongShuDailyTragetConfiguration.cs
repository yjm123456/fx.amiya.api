...
namespace Fx.Amiya.DbModels.DBModelConfigs
{
    public class BeforeLivingXiaoHongShuDailyTragetConfiguration : IEntityTypeConfiguration<BeforeLivingXiaoHongShuDailyTarget>
    {
        public void Configure(EntityTypeBuilder<BeforeLivingXiaoHongShuDailyTarget> builder)
        {
            ...
            builder.Property(t => t.XiaoHongShuPrivateMessageOpen).HasColumnName("xiaohongshu_private_message_open").HasColumnType("int").IsRequired();
            builder.Property(t => t.XiaoHongShuCallingCardSendNum).HasColumnName("xiaohongshu_calling_card_sendnum").HasColumnType("int").IsRequired();
