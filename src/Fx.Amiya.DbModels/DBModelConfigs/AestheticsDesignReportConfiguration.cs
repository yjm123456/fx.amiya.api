...
namespace Fx.Amiya.DbModels.DBModelConfigs
{
    public class AestheticsDesignReportConfiguration : IEntityTypeConfiguration<AestheticsDesignReport>
    {
        public void Configure(EntityTypeBuilder<AestheticsDesignReport> builder)
        {
            ...
            builder.Property(e => e.HistoryDescribe2).HasColumnName("history_describe2").HasColumnType("varchar(3000)").IsRequired(false);
            builder.Property(e => e.HistoryDescribe3).HasColumnName("history_describe3").HasColumnType("varchar(3000)").IsRequired(false);
