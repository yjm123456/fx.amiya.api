...
namespace Fx.Amiya.DbModels
{
    public class AmiyaDbContext : DbContext
    {
        ...
        public virtual DbSet<EmployeePerformanceTarget> EmployeePerformanceTarget { get; set; }
        ...
        public virtual DbSet<LiveAnchorMonthlyTargetAfterLiving> LiveAnchorMonthlyTargetAfterLiving { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfiguration(new EmployeePerformanceTargetConfiguration());
            ...
            modelBuilder.ApplyConfiguration(new LiveAnchorMonthlyTargetAfterLivingConfiguration());
