...
{
    public record GoodsInfoUpdateDto
    { 
      ...
      /// </summary>
        ...
        /// 门店价格
        /// </summary>
        public List<GoodsHospitalPriceAddDto> GoodsHospitalsPrice { get; set; }
        /// <summary>
        /// 规格价格
        /// </summary>
        ...
        /// 会员价格
        /// </summary>
        public List<GoodsMemberRankPriceAddDto> GoodsMemberRankPrice { get; set; }
        /// <summary>
        /// 抵用券
        /// </summary>
        public List<GoodsConsumptionVoucherAddDto> GoodsConsumptionVoucher { get; set; }
        /// <summary>
        /// 商品标签
        /// </summary>
        public List<GoodsTagDto> GoodsTags { get; set; }
        /// <summary>
        /// 商品html内容
        /// </summary>
        public string GoodsDetailHtml { get; set; }
        public List<GoodsInfoCarouselImageUpdateDto> CarouselImageUrls { get; set; }
    }
}
